...
class Admin_Inventory_create:
    def __init__(self):
        ...
        assets_path = Path(r"D:\Study\HK2\KY THUAT LAP TRINH\Do_an-cuoi_ki_Nhom2\File\Images\Admin\Inventory")
        ...
        self.movies_button = Button(image=self.movies_image, borderwidth=0, highlightthickness=0,
                               command=lambda: aip.Admin_Inventory_process.movies_button_handle(self))
        ...
        self.inventory_button = Button(image=self.inventory_image, borderwidth=0, highlightthickness=0,
                               command=lambda: aip.Admin_Inventory_process.inventory_button_handle(self))
        ...
        self.sales_button = Button(image=self.sales_image, borderwidth=0, highlightthickness=0,
                               command=lambda: aip.Admin_Inventory_process.sales_button_handle(self))
        ...
        self.users_button = Button(image=self.users_image, borderwidth=0, highlightthickness=0,
                               command=lambda: aip.Admin_Inventory_process.users_button_handle(self))
        ...
        self.switch_button = Button(image=self.switch_image, borderwidth=0, highlightthickness=0,
                               command=lambda: aip.Admin_Inventory_process.switch_button_handle(self))
        ...
        self.exit_button = Button(image=self.exit_image, borderwidth=0, highlightthickness=0,
                               command=lambda: aip.Admin_Inventory_process.exit_button_handle(self))
